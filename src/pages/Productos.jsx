...
export default function Productos({ products, categories, onAdd, onEdit, onDelete, onAdjustStock }) {
...
function ProductModal({ initialData, categories, onClose, onSave }) {
  const [form, setForm] = useState(initialData || { name: "", sku: "", category: categories[0]?.name || "", stock: 0, minStock: 5, price: 0 });
